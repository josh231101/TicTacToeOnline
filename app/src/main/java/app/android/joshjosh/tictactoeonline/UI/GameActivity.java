...
import app.android.joshjosh.tictactoeonline.APP.Constantes;
import app.android.joshjosh.tictactoeonline.R;
import app.android.joshjosh.tictactoeonline.model.Jugada;
...
public class GameActivity extends AppCompatActivity {
    ...
    private void initViews() {
        tvPlayer1 = findViewById(R.id.textViewPlayerOne);
        tvPlayer2 = findViewById(R.id.textViewPlayerTwo);
